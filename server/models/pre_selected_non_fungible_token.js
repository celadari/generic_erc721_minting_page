...
const definePreSelectedNonFungibleToken = async () => {
    await sequelize.query('CREATE SEQUENCE IF NOT EXISTS pre_selected_non_fungible_tokens_token_id_seq AS INTEGER MINVALUE 0 MAXVALUE 9337 START 0 INCREMENT 1');
